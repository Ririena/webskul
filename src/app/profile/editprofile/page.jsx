...
export default function EditProfile() {
  ...
  const onSubmit = async (data) => {
    ...
    if (croppedImageFile) {
      ...
      const { data: uploadData, error: uploadError } = await supabase.storage
        .from("images")
        .upload(`images/${croppedImageFile.name}`, croppedImageFile);
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <Card className="bg-white dark:bg-neutral-900 rounded-lg shadow-lg">
        <CardHeader>
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  className="mt-1 p-2 border rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:focus:ring-blue-400"
                  {...register("noAbsen", {
            ...
            <div className="flex justify-center gap-4 mt-6">
              ...
              <Button className="w-full" variant="solid" size="sm" type="submit">
                Save Changes
              </Button>
            </div>
          </form>
